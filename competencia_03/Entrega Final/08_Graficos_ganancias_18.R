...
#cargo datasets
resultados_ganancia_baseline<-read_csv("C:/Users/mabil/Documents/DATA_MINING/DMEyF/competencia_final/Bayesianas_finales/ensembles_LR1/18/resultados_ganancia_baseline.csv")
resultados_ganancia_ensembles<-read_csv("C:/Users/mabil/Documents/DATA_MINING/DMEyF/competencia_final/Bayesianas_finales/ensembles_LR1/18/resultados_ganancia.csv")
resultados_ganancia_50_ensembles<-read_csv("C:/Users/mabil/Documents/DATA_MINING/DMEyF/competencia_final/Bayesianas_finales/ensembles_LR1/18/resultados_ganancia_ensembles.csv")

#seteo directorio
setwd("C:/Users/mabil/Documents/DATA_MINING/DMEyF/competencia_final/Bayesianas_finales/ensembles_LR1/18/")
...
gg <- gg + geom_line(aes(y = ganancia_31), color = "red", size = 0.5)
...
# Gráfico de densidad
# Filtrar la fila donde envios es igual a 12000
fila_filtrada <- resultados_ganancia_ensembles %>%
  filter(envios == 12000)

# Obtener el valor del ensemble de 30 semillas
valor_ganancia_31 <- fila_filtrada$ganancia_31
...
density_plot <- ggplot() +
  ...
  geom_vline(xintercept = valor_ganancia_31, linetype = "dashed", color = "red", size = 1) +
